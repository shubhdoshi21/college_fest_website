  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col items-center px-10">
        ...
        <ul className="list-disc mt-[5vh]">
          <li>Follow the visiting rules and regulations applicable on the premises.</li>
          ...
          <li>Technical companies are limited to specified departments only.</li>
        </ul>
...
<img src={i1} alt="" /><p className=" text-center p-1">Arena Animation</p>
        </div>
        <div className="w-[50vw] p-10">
<img src={i2} alt="" /><p className=" text-center p-1">Radio Mirchi</p>
        </div>
      </div>
    </div>
  );
