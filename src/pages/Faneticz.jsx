...
import i3 from "../assets/shubh/images/view-finder.jpeg";
import i4 from "../assets/shubh/images/meme.jpg";
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex items-center justify-center">
        <img src={i2} alt="Faneticz" className="w-[90vw] px-[5vw]" />
      </div>
      <div className="flex  text-white text-center flex-wrap py-[10vh] justify-center px-[10vw]">
        <div className="w-[40vw] px-[5vw] md:w-[80vw]">
          {" "}
          <img src={i3} alt="View-Finder" />
          <p className="py-[3vh] text-xl font-semibold">View-Finder</p>
          <p className="text-justify pb-[3vh]">
            It's often said that if your imagination is out of focus, you can't
            expect your camera to take the perfect shot. Photography is an
            austere and blazing poetry of the real. Try and test out your
          ...
          <div className="text-left">
            ...
            <ul className="list-disc py-[3vh]">
              ...
              <p>
                Your photograph for competition (only one photograph is allowed)
              </p>
              ...
              <p>
                The best ones will be shortlisted by our team from all entries.
              </p>
              <p>
        ...
        <div className="w-[40vw] px-[5vw] md:w-[80vw]">
          <img src={i4} alt="Meme-Mania" />
          <p className="py-[3vh] text-xl font-semibold">Meme-Mania</p>
          <p className="text-justify pb-[3vh]">
            Sarcasm and Humor together are rare qualities but also essential for
            memes. If you can pull off both and make your meme hilarious then we
            bring you "Meme Mania", where you get a platform to show your
            creativity and win prizes.
          </p>
          <div className="text-left">
            <p>Total Fees : ₹20 /-</p>
            <p>Participation : Individual</p>
            ...
            <ol className="list-decimal">
              ...
              <li>
                Memes should not target any religion, community or sentiments of
            ...
            <ul className="list-disc py-[3vh]">
              ...
              <p>
                You have to submit your photo on mememania.paramarsh22@gmail.com
              </p>
              <p>Format of Email :-</p>
              <p>
                Subject : first name - middle name - surname (same as file
