    ...
    <div className="bg-black text-white">
      ...
      <div className="flex flex-wrap items-center justify-center">
        <div className=" text-9xl md:text-8xl sm:text-6xl xs:text-4xl pt-[25vh] px-3 w-[100vw] text-center">
          ...
          <p className="text-xl px-8 pt-[5vh] text-center">
        ...
        <div className="px-[20vw] py-[5vh]">
          ...
          <ol className="list-decimal">
            ...
            <li>Ensure your availability on the day of the event before participating.</li>
            <li> Participants will be short listed on the basis of : -
            ...
            <li>Shortlisted participants will get an opportunity to pitch their ideas in front of investors and jury.</li>
          </ol>
        </div>
        <div className="px-[20vw] py-[5vh]">
